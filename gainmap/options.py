...
class FeatureOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='woman', help='name of the dataset')
        parser.add_argument('--outf', type=str, default='woman_test', help='name of the dataset')
        ...
        # Weight parameters
        parser.add_argument('--alpha_3', type=float, default=0.8, help='layer preference of conv3 first term')
        parser.add_argument('--alpha_4', type=float, default=0.8, help='layer preference of conv4 first term')
        ...
        parser.add_argument('--gT', type=float, default=5e-9, help='balance two terms in the total loss')
